...
title: Migration to AI SDK v6
sidebar:
  order: 99
description: Migrate your Agents SDK projects from AI SDK v5 to v6 with unified tool patterns and improved functionality
---

import { Render, PackageManagers, TypeScriptExample, TabItem, Tabs, Details } from "~/components";
...
<Tabs>
<TabItem label="Before (v5 - Deprecated)" icon="x-circle">
...
<TabItem label="After (v6 - Recommended)" icon="check-circle">
...
<Tabs>
<TabItem label="Before (v5)" icon="x-circle">
...
<TabItem label="After (v6)" icon="check-circle">
