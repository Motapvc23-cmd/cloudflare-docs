...
sidebar:
  order: 10
description: Migrate your Agents SDK project from AI SDK v5 to AI SDK v6 (beta) with this step-by-step guide
---

import { PackageManagers, TypeScriptExample, Render } from "~/components";
